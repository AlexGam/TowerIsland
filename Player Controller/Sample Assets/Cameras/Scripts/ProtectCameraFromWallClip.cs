...
public class ProtectCameraFromWallClip : MonoBehaviour
{
	...
	void Start() {
		...
		pivot = cam.parent;
		zoom = -10;
		originalDist = cam.localPosition.magnitude+10;
		currentDist = originalDist-10;
	...
	float curZoom =Input.GetAxis ("Mouse ScrollWheel")*2;
		zoom -= curZoom;
		zoom = Mathf.Clamp (zoom, -16, 0);

		float targetDist = originalDist + zoom;
		...
		currentDist = Mathf.SmoothDamp(currentDist, targetDist, ref moveVelocity, clipMoveTime );
